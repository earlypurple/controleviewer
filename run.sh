...
echo "👆 Index pointé = Déplacer curseur (suivi continu)"
echo "🤏 Pince (pouce+index) = Clic gauche"
echo "✊ Poing fermé = Clic droit"
echo "✌️ Signe de paix = Double clic"
echo "👍 Pouce levé = Défiler vers le haut"
echo "✋ Main ouverte = Mission Control"
echo ""
